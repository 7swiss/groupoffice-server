 ...
 */
abstract class FileSystemObject extends Object {
...
//		\IFW::app()->debug("FS construct $path");
...
//		return is_dir($this->path);
		return is_a($this, \IFW\Fs\Folder::class); //works with non existing files
	}
...
//		return is_file($this->path);
		return is_a($this, \IFW\Fs\File::class); //works with non existing files
	}
	...
	public function isTemporary() {
		return $this->isDescendantOf(\IFW::app()->getConfig()->getTempFolder());
	}
	...
	public function getRelativePath(Folder $fromFolder) {
		if (!$this->isDescendantOf($fromFolder)) {
			throw new \Exception("The given folder is not an ancestor of this folder or file");
		} else {
