...
-- INSERT IGNORE INTO `contacts_account_group` (`accountId`, `groupId`, `write`) select id, 2, 2 from accounts_account where modelName="GO\\Modules\\GroupOffice\\Contacts\\Model\\Account" limit 0,1;
